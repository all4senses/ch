...
// Ookla speed test page original content. -------------------------------------------------------------------------------
  ...
  $path_to_custom_js = drupal_get_path('module', 'ch_pages') . '/js/';
  drupal_add_js($path_to_custom_js . 'ch_speedtest_page.js');
     ...
     <div class="share">
       <div class="main">
              ...
              <?php
                ...
                echo ch_blocks_getSocialiteButtons($url, $share_title); 
